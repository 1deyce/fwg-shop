...
const Header = () => {
    ...
    return (
        <header className="bg-white absolute inset-x-0 top-0 z-50 mx-10 max-h-[100px]">
            <nav aria-label="Global" className="flex items-center justify-between p-6 lg:px-8">
                <div className="flex lg:flex-1">
                    <a href="/" className="">
                        <span className="text-black sr-only">Shop FWG</span>Shop <span className='font-semibold'>FWG</span> 
                    </a>
                </div>
